<template>
    <div>
        <!-- Navbar -->
        <nav class="navbar navbar-expand-md navbar-light fixed-top px-2 p-0"
            style="background-color: var(--secondary-color);">
            <!-- Back Arrow (Shown on Mobile) -->
            <div class="d-md-none mr-auto">
                <router-link to="/" style="color: var(--primary-color);"><i
                        class="bi bi-chevron-left fs-2"></i></router-link>
            </div>
